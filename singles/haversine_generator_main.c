        ...
        if (PairCount < MaxPairCount)
        {
            ...
            if (FlexJSON && HaverAnswers)
            {
                ...
                for (u64 PairIndex = 0; PairIndex < PairCount; ++PairIndex)
                {
                    ...
                    f64 HaversineDistance = calc_haversine(X0, Y0, X1, Y1, EarthRadius);
...
type: cluster, seed: 3
pairs: 100
average = 4435.1267433466991861

Method: cluster
Random seed: 7
Pair count: 1000000
Expected sum: 5280.7140542049246505
0
0
